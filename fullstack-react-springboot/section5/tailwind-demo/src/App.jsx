...
function App() {
  return (
    <>
      ...
      <p className="text-lg underline font-bold mt-4 text-orange-600">
        Tailwind makes styling easy!
      </p>
      <div className="bg-gray-300 p-4 m-4">Background color demo</div>
      <div className="p-4  rounded-lg m-4 bg-green-300 border border-green-800">
        Border demo
      </div>
      ...
      {/*"shift + alt + a" comment out, "shift + alt + a" again to decomment again*/}
      ...
      <div className="p-4  rounded-lg m-4 bg-[#CC6958] border border-[#87554E] h-[165px] w-[300px] flex justify-center items-center">
        {/*bg-[#CC6958] to apply a custmized colour to tailwind*/}
        custom Width, Height and Color
      </div>
      <div className="p-4  rounded-lg m-4 bg-mintAtTheme-500 border border-[#87554E] h-[165px] w-[300px] flex justify-center items-center">
        {/*bg-mintAtTheme-500 is defined in App.css*/}
        Color from Theme at App.css
      </div>
      <div className="p-4  rounded-lg m-4 bg-primary font-display border border-[#87554E] h-[165px] w-[300px] flex justify-center items-center">
        {/*bg-mintAtTheme-500 is defined in App.css*/}
        Color and Font from Theme at App.css
      </div>
    </>
  );
}
